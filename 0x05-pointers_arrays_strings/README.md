This directory contains scripts that illustrate the use of pointers, arrays, the differences between pointers and arras, strings and how to use them, and related stuff.
